...
def build_dependencies():
    ...
    http_archive(
        ...
        build_file = "//bazel/third_party:BUILD.py_yaml.bazel",
    )
...
def binary_dependencies():
    """Declare external dependencies that supply binaries used by the build."""
...
def manifest_dependencies():
    """Declare external dependencies that supply third-party Kubernetes manifests."""
